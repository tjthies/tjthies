...
class Scoreboard:
    """A class to manage the score in alien invasion."""
    ...
    def prep_ships(self):
        ...
        self.ships = Group()
        for ship_number in range(self.stats.ships_available):
    ...
    def prep_high_score(self):
        ...
        # Center teh high score a the top of the screen
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx
        self.high_score_rect.top = self.score_rect.top

    def check_high_score(self):
        """Check for, and udpate high score."""
